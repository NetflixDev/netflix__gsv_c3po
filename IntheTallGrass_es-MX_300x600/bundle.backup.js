(function (){
  ...
  function animateRibbon() {
    ...
    setTimeout(function () { l.transform = 'matrix(1, 0, 0, 1, 0, -600)' }, 1000)
    setTimeout(function () { m.transform = 'translate(-50%, 100%) matrix(1, 0, 0, 1, 0, 0)' }, 1200)
    setTimeout(function () { r.transform = 'matrix(1, 0, 0, 1, 0, -600)' }, 1400)
  }
  ...
  function buildAd(monetAssets) {
    ...
    try {
      ...
      monetAssets.assetGroups.forEach(function(d, i) {
        data[i] = {
          img: d['image.Single_Image_300x600_C20'].url,
